...
<template>
  <BaseFlex justify="center" align="start" class="gap-[20px]">
    ...
    <BaseFlex class="relative w-full">
      ...
      <input
          ...
          :max="max"
          :step="step ?? 1"
          class="file:text-foreground mt-2 placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input h-9 w-full min-w-0 rounded-sm border bg-transparent px-3 py-1 text-[16px] md:text-base transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:shadow-sm aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive"
          :class="{
            'pl-8': $slots.prefix,
            'pr-14': $slots.suffix,
          }"
